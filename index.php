                    ...
                    <div class="well">
                        ...
                        <form class="form-horizontal" action="" method="POST">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control" id="inputEmail3" placeholder="Email eg.fahim@gmail.com"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
                                <div class="col-sm-10">
                                    <input type="password" name="password" class="form-control" id="inputPassword3" placeholder="Password eg.123456"/>
                                </div>
                            </div>
                            <div class="form-group">
